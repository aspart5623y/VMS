    ...
    <main>
        ...
        <section class="sidebar bg-white shadow">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="sidebar-nav list-unstyled">
                    ...
                    <li class="sidebar-item">
                        <!-- sidebar link -->
                        <a href="./manage-vehicles.php" class="sidebar-link border-bottom <?php if($page == 'manage vehicle') {echo 'active';} ?>">
                            Manage Vehicles
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <!-- sidebar link -->
                        <a href="#routes" data-toggle="collapse" <?php if($page == 'update routes' OR $page == 'update hazard') {echo 'aria-expanded = "true"';} ?> class="sidebar-link border-bottom">
                            Routes
                            <span class="arrow float-right">
                                <i class="fas fa-angle-down"></i>
                            </span>
                        </a>
                        <div class="collapse <?php if($page == 'update routes' OR $page == 'update hazard') {echo 'show';} ?>" id="routes">
                            <ul class="list-unstyled pl-4">
                                <!-- sidebar item -->
                                <li class="sidebar-item">
                                    <!-- sidebar link -->
                                    <a href="./update-routes.php" class="sidebar-link border-bottom <?php if($page == 'update routes') {echo 'active';} ?>">
                                        Update Travelling Routes
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item">
                                    <!-- sidebar link -->
                                    <a href="./update-hazard.php" class="sidebar-link border-bottom <?php if($page == 'update hazard') {echo 'active';} ?>">
                                        Update Routes hazard levels
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="mainbody">
            <!-- 
                ...
                |***********************************|
            -->
            <nav class="navbar unscrolled <?php if($page == 'home') {echo 'unscrolled';} else {echo 'scrolled shadow-sm';} ?> navbar-light fixed-top">
